...
if ( vamtam_theme_supports( [ 'posts--load-more-masonry-fix', 'posts-base--404-handling-fix', 'posts-base--display-categories' ] ) ) {
	// Vamtam_Widget_Posts.
		...
		class Vamtam_Widget_Posts extends Elementor_Posts {
			...
			*/
			public function get_script_depends() {
				...
				if (  vamtam_theme_supports( 'posts--load-more-masonry-fix' ) ) {
					$script_depends[] = 'vamtam-posts';
				}
			...
			*/
			...
			public function register_assets() {
				...
				if (  vamtam_theme_supports( 'posts--load-more-masonry-fix' ) ) {
					wp_register_script(
						'vamtam-posts',
						VAMTAM_ELEMENTOR_INT_URL . '/assets/js/widgets/posts/vamtam-posts' . $suffix . '.js',
						[
							'elementor-frontend'
						],
						\VamtamElementorIntregration::PLUGIN_VERSION,
