	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'avvocato' ),
				'iconName'   => esc_html__( 'Icon', 'avvocato' ),
				'iconText'   => esc_html__( 'Text', 'avvocato' ),
				'iconLink'   => esc_html__( 'Link', 'avvocato' ),
				'iconChange' => esc_html__( 'Change', 'avvocato' ),
