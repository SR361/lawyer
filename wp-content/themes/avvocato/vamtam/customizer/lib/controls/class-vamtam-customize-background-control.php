...
class Vamtam_Customize_Background_Control extends Vamtam_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels, array(
			'select'       => esc_html__( 'Select Image', 'avvocato' ),
			'change'       => esc_html__( 'Change Image', 'avvocato' ),
			'remove'       => esc_html__( 'Remove', 'avvocato' ),
			'default'      => esc_html__( 'Default', 'avvocato' ),
			'placeholder'  => esc_html__( 'No image selected', 'avvocato' ),
			'frame_title'  => esc_html__( 'Select Image', 'avvocato' ),
			'frame_button' => esc_html__( 'Choose Image', 'avvocato' ),
		) );
		...
		self::$selects = array(
			'background-repeat' => array(
				'no-repeat' => esc_html__( 'No repeat', 'avvocato' ),
				'repeat-x'  => esc_html__( 'Repeat horizontally', 'avvocato' ),
				'repeat-y'  => esc_html__( 'Repeat vertically', 'avvocato' ),
				'repeat'    => esc_html__( 'Repeat both', 'avvocato' ),
			),
			'background-attachment' => array(
				'scroll' => esc_html__( 'scroll', 'avvocato' ),
				'fixed'  => esc_html__( 'fixed', 'avvocato' ),
			),
			'background-size' => array(
				'auto'    => esc_html__( 'auto', 'avvocato' ),
				'cover'   => esc_html__( 'cover', 'avvocato' ),
				'contain' => esc_html__( 'contain', 'avvocato' ),
			),
			'background-position' => array(
				'left top'      => esc_html__( 'left top', 'avvocato' ),
				'left center'   => esc_html__( 'left center', 'avvocato' ),
				'left bottom'   => esc_html__( 'left bottom', 'avvocato' ),
				'center top'    => esc_html__( 'center top', 'avvocato' ),
				'center center' => esc_html__( 'center center', 'avvocato' ),
				'center bottom' => esc_html__( 'center bottom', 'avvocato' ),
				'right top'     => esc_html__( 'right top', 'avvocato' ),
				'right center'  => esc_html__( 'right center', 'avvocato' ),
				'right bottom'  => esc_html__( 'right bottom', 'avvocato' ),
			),
		);
	}
	...
	public function to_json() {
		...
		$this->json['alt_medium']    = esc_html__( 'Medium-sized attachment', 'avvocato' );
		$this->json['alt_full']      = esc_html__( 'Full-sized attachment', 'avvocato' );

		$this->json['option_labels'] = array(
			'background-type'       => esc_html__( 'Background Type', 'avvocato' ),
			'background-repeat'     => esc_html__( 'Repeat', 'avvocato' ),
			'background-image'      => esc_html__( 'Image', 'avvocato' ),
			'background-attachment' => esc_html__( 'Attachment', 'avvocato' ),
			'background-size'       => esc_html__( 'Size', 'avvocato' ),
			'background-position'   => esc_html__( 'Position', 'avvocato' ),
			'background-color'      => esc_html__( 'Color', 'avvocato' ),
			'background-gradient'   => [
				'color-1'              => esc_html__( 'Color 1', 'avvocato' ),
				'color-2'              => esc_html__( 'Color 2', 'avvocato' ),
				'location'             => esc_html__( 'Location', 'avvocato' ),
				'type'                 => esc_html__( 'Type', 'avvocato' ),
				'position'             => esc_html__( 'Position', 'avvocato' ),
				'angle'                => esc_html__( 'Angle', 'avvocato' ),
			],
		);
		...
		$this->json['l10n'] = array(
			'background-gradient'   => [
				'type'              => [
					'linear' => esc_html__( 'Linear', 'avvocato' ),
					'radial' => esc_html__( 'Radial', 'avvocato' ),
				],
				'position'          => [
					'center center' =>  esc_html__( 'Center Center' , 'avvocato' ),
					'center left'   =>  esc_html__( 'Center Left' , 'avvocato' ),
					'center right'  =>  esc_html__( 'Center Right' , 'avvocato' ),
					'top center'    =>  esc_html__( 'Top Center' , 'avvocato' ),
					'top left'      =>  esc_html__( 'Top Left' , 'avvocato' ),
					'top right'     =>  esc_html__( 'Top Right' , 'avvocato' ),
					'bottom center' =>  esc_html__( 'Bottom Center' , 'avvocato' ),
					'bottom left'   =>  esc_html__( 'Bottom Left' , 'avvocato' ),
					'bottom right'  =>  esc_html__( 'Bottom Right' , 'avvocato' ),
				],
			],
		);
