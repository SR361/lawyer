...
class Vamtam_Customize_Responsive_Box_Fields_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'top'       => esc_html__( 'Top', 'avvocato' ),
			'right'     => esc_html__( 'Right', 'avvocato' ),
			'bottom'    => esc_html__( 'Bottom', 'avvocato' ),
			'left'      => esc_html__( 'Left', 'avvocato' ),
			'padding'   => esc_html__( 'Padding', 'avvocato' ),
		);
	}
	/**
