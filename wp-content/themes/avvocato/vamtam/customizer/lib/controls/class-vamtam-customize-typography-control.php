...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'avvocato' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'avvocato' ),
			'font-weight'                     => esc_html__( 'Weight', 'avvocato' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'avvocato' ),
				'uppercase'    => esc_html__( 'Uppercase', 'avvocato' ),
				'lowercase'    => esc_html__( 'Lowercase', 'avvocato' ),
				'capitalize'   => esc_html__( 'Capitalize', 'avvocato' ),
				'normal'       => esc_html__( 'Normal', 'avvocato' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'avvocato' ),
				'normal'       => esc_html__( 'Normal', 'avvocato' ),
				'italic'       => esc_html__( 'Italic', 'avvocato' ),
				'oblique'      => esc_html__( 'Oblique', 'avvocato' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'avvocato' ),
				'underline'    => esc_html__( 'Underline', 'avvocato' ),
				'overline'     => esc_html__( 'Overline', 'avvocato' ),
				'line-through' => esc_html__( 'Line Through', 'avvocato' ),
				'none'         => esc_html__( 'None', 'avvocato' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'avvocato' ),
			'line-height'                => esc_html__( 'Line Height', 'avvocato' ),
			'color'                      => esc_html__( 'Font Color', 'avvocato' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'avvocato' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'avvocato' ), [ 'code' => [] ] ),
		);
	}
	/**
